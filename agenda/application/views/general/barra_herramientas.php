<div class="row" id="no-print"> <!-- Inicia Barra de Herramientas-->
  ...
  <div class="large-12 large-centered columns">
    ...
    <a class="small button" href="<?=base_url(); ?>index.php/tareas/mostrar_vistas_c/asignar_ta">
     ...
     <a class="small button" href="<?=base_url(); ?>index.php/tareas/mostrar_vistas_c/agregar_usuario/">
      <i class="foundicon-plus"> Agregar usuario </i>
    </a> 
