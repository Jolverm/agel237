       ...
       <?php if(isset($tareas)): foreach ($tareas as $tarea): ?>
            ...
            <fieldset>
                <legend>Fecha y Hora</legend>
                    ...
                    <labelstyle="display:none"  class="firmas">Hora</label>
                    <input style="display:none"  class="firmas" type="time" name="hora" value="<?=(isset($tarea['hora'])) ? $tarea['hora'] : ''; ?>" placeholder="hh:mm" />                    
            </fieldset>
            ...
            <fieldset>
                <legend>Datos generales</legend>
                    ...
                    <select style="display:none"  class="firmas" name="rpp">
                        <option value="NA" <?=($tarea['rpp'] == 'NA') ? 'selected="selected"' : ''; ?>>NA</option>
    ...
    <select class="large-2 small-6 small-offset-3 large-offset-3  large-centered tipoTramite" id="id_tipo_tarea" name="id_tipo_tarea">
     ...
     <fieldset class="large-6 small-6 small-centered large-centered columns">
        <legend>Fecha y Hora</legend>
            ...
            <div>
                 <label class="firmas">Hora</label>
                 <input class="firmas"type="time" name="hora" placeholder="hh:mm">
            </div>
    </fieldset>
